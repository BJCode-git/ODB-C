...
do
  ...
  ./scripts/launch_servs.sh 0 $size

  # Répertoires et fichiers
  BASE_DIR=results/servs-${size}
  LOCUST_FILES_DIR=$BASE_DIR/locust-vanilla
  LOCUST_GRAPH_FILES_DIR=$BASE_DIR/graphs-vanilla
  CPU_LOG_FILE=$BASE_DIR/cpu-vanilla.log
  CPU_GRAPH_DIR=$BASE_DIR/graphs-vanilla-cpu-conso/
