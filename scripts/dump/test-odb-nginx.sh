...
./scripts/launch-nginx.sh 1 0

# Répertoires et fichiers
LOCUST_FILES_DIR=results/nginx/locust-odb
LOCUST_GRAPH_FILES_DIR=results/nginx/graphs-odb
CPU_LOG_FILE=results/nginx/cpu-odb.log
CPU_GRAPH_DIR=results/nginx/graphs-odb-cpu-conso/
