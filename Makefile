...
$(ODB_LIB): $(LIB_DIR) 
	$(CC) $(CFLAGS) -I$(INCLUDE_DIR) -shared -fPIC -ldl -rdynamic $(ODB_SRC)  -DSEND_UNALIGNED_DATA=$(USE_UNALIGNED_SENDING) -DEQU_ALIGN=$(USE_EQU_ALIGN) -DODB=$(USE_ODB) -DDEBUG=$(DEBUG) -DODB_STANDALONE=$(USE_STANDALONE) -o $(ODB_LIB)
$(FE_LIB): $(LIB_DIR) 
	$(CC) $(CFLAGS) -I$(INCLUDE_DIR) -shared -fPIC -ldl -rdynamic $(ODB_SRC)  -DSEND_UNALIGNED_DATA=$(USE_UNALIGNED_SENDING) -DEQU_ALIGN=$(USE_EQU_ALIGN) -DODB=$(USE_ODB) -DDEBUG=$(DEBUG) -DODB_STANDALONE=$(USE_STANDALONE) -DLOG_STATUS=\"FRONT_END\" -o $(FE_LIB)
$(IS_LIB): $(LIB_DIR) 
	$(CC) $(CFLAGS) -I$(INCLUDE_DIR) -shared -fPIC -ldl -rdynamic $(ODB_SRC)  -DSEND_UNALIGNED_DATA=$(USE_UNALIGNED_SENDING) -DEQU_ALIGN=$(USE_EQU_ALIGN) -DODB=$(USE_ODB) -DDEBUG=$(DEBUG) -DODB_STANDALONE=$(USE_STANDALONE) -DLOG_STATUS=\"INTERMEDIATE_SERVER\" -o $(IS_LIB)
$(BE_LIB): $(LIB_DIR) 
	$(CC) $(CFLAGS) -I$(INCLUDE_DIR) -shared -fPIC -ldl -rdynamic $(ODB_SRC)  -DSEND_UNALIGNED_DATA=$(USE_UNALIGNED_SENDING) -DEQU_ALIGN=$(USE_EQU_ALIGN) -DODB=$(USE_ODB) -DDEBUG=$(DEBUG) -DODB_STANDALONE=$(USE_STANDALONE) -DLOG_STATUS=\"BACK_END\" -o $(BE_LIB)
